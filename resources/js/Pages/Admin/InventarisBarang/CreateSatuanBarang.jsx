...
const CreateSatuanBarang = ({ status }) => {
    ...
    const handleSubmit = (values) => {
        setLoading(true)
        router.post(route('admin.inventaris-barang.satuan.create.action'), values, {
            onSuccess: () => {
                setLoading(false);
            },
            onError: () => {
        ...
        <form onSubmit={form.onSubmit(handleSubmit)}>
            <Stack gap={"md"}>
                <Group justify='space-between' align='center'>
                    <Text size='sm'>Tambah Satuan Barang</Text>
