...
const RiwayatPengajuan = ({ user, paginatedPengajuans, timKerja, filters }) => {
    ...
    const handleRouteVisit = () => {
        router.visit(route('admin.pengajuan.riwayat-pengajuan', { page, dateRange: localDateRange, statuses: localSelectedStatus, keyword: debouncedKeyword, timKerjas: localSelectedTimKerja }), {
